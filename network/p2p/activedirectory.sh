...
if is_fedora || is_ostree || is_rhel; then
    pkg_install --bypass sssd realmd oddjob oddjob-mkhomedir adcli samba-common samba-common-tools krb5-workstation openldap-clients policycoreutils-python-utils
elif is_ubuntu; then
